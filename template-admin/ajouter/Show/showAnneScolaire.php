        ...
        <div class="container-header">
            ...
            <div class="table-container">
                <table>
                    <thead>
                        <tr>
                            <th>ID Anne Scolaire</th>
                            <th>Nom de Anne Scolaire</th>
                            <th>Action</th>
                        </tr>
                        </thead>
                        ...
                        <tr>
                            <?php $AnneS=$inf['id_AnneS'] ;?>
                            
                            <td><?= $inf['id_AnneS'] ?></td>
                            <td><?= $inf['annee'] ?></td>
                    
                            <td>
                                <button style="margin: 5px;" class="update"><a href="update.php?id_AnneS=<?php echo $AnneS ?>">update</a></button>
                                <button class="delete"><a href="../Delete/DeleteAnneScolaire?id_AnneS=<?php echo $AnneS ?>" onclick="return confirm ('Êtes-vous sûr de vouloir supprimer ceci ?')">delete</a></button>
                            </td>

        ...
        <div class="container-header">
            <div class="notes-header">
                ...
                <div class="filter-container">
                    ...
                    <button class="ajouter-btn" id="ajoute"><a href="../Option.php">Ajouter Option</a></button>
                    </div>
                ...
                <table>
                    <thead>
                        ...
                        <tr>
                            ...
                            <td>
                            <?php $option=$inf['id_option']?>
                                <button style="margin: 5px;" class="update"><a href="update.php?id_option=<?php echo $option ?>">update</a></button>
                                <button class="delete"><a href="../Delete/DeleteOption?id_option=<?php echo $option ?>" onclick="return confirm ('Êtes-vous sûr de vouloir supprimer ceci ?')">delete</a></button>
                            </td>

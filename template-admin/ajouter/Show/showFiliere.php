        ...
        <div class="container-header">
            <div class="notes-header">
                ...
                <div class="filter-container">
                    ...
                    <button class="ajouter-btn" id="ajoute"><a href="../Insert/Filliere.php">Ajouter Filière</a></button>
                    </div>
                ...
                <table>
                    <thead>
                        ...
                        <tr>                
                            ...
                            <td><?= $inf['filiere_name'] ?></td>

                            <td>
                            <?php $FiliereID=$inf['filiere_id']?>
                                <button style="margin: 5px;" class="update"><a href="update.php?filiere_id=<?php echo $FiliereID ?>">update</a></button>
                                <button class="delete"><a href="../Delete/DeleteFiliere?filiere_id=<?php echo $FiliereID ?>" onclick="return confirm ('Êtes-vous sûr de vouloir supprimer ceci ?')">delete</a></button>
                            </td>

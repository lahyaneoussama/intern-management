        ...
        <div class="container-header">
            <div class="notes-header">
                ...
                <div class="filter-container">
                    ...
                    <button class="ajouter-btn" id="ajoute"><a href="../Insert/matiere.php">Ajouter Matiere</a></button>
                    </div>
            ...
            <div class="table-container">
                <table>
                    <thead>
                        ...
                        <tr>
                            <?php $subjectid=$inf['subject_id'] ;?>
                            
                            <td><?= $inf['subject_id'] ?></td>
                            <td><?= $inf['subject_name'] ?></td>
                            <td><?= $inf['Coefficient'] ?></td>
                            <td><?= $inf['filiere_id'] ?></td>
                            <td><?= $inf['id_option'] ?></td>
                            <td><?= $inf['id_niveau'] ?></td>
                            <td>
                            <?php $subjectid=$inf['subject_id']?>
                                <button style="margin: 5px;" class="update"><a href="update.php?subject_id=<?php echo $subjectid ?>">update</a></button>
                                <button class="delete"><a href="../Delete/DeleteSubject?subject_id=<?php echo $subjectid ?>" onclick="return confirm ('Êtes-vous sûr de vouloir supprimer ceci ?')">delete</a></button>
                            </td>

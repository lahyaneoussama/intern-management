        ...
        <div class="container-header">
            <div class="notes-header">
                ...
                <div class="filter-container">
                    ...
                    <button class="ajouter-btn" id="ajoute"><a href="../Insert/Niveau.php">Ajouter Niveau</a></button>
                    </div>
                ...
                <table>
                    <thead>
                        ...
                        <tr>
                            ...
                            <td><?= $inf['id_niveau'] ?></td>
                            <td><?= $inf['nom_niveau'] ?></td> 

                            <td>
                            <?php $Niveau=$inf['id_niveau']?>
                                <button style="margin: 5px;" class="update"><a href="update.php?id_niveau=<?php echo $Niveau ?>">update</a></button>
                                <button class="delete"><a href="../Delete/DeleteNiveau?id_niveau=<?php echo $Niveau ?>" onclick="return confirm ('Êtes-vous sûr de vouloir supprimer ceci ?')">delete</a></button>
                            </td>

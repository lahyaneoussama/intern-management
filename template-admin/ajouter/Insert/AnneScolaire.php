...
<body>
    <?php
        ...
        if (isset($_POST['creer'])) {
            ...
            $AnneSNom = $_POST['AnneSName'];
            $AnneSId = $_POST['AnneSId'];


            $sql = "INSERT INTO `anneescolaire`(`id_AnneS`, `annee`)
             VALUES (?,?)";
            $requite= $db->prepare($sql);
            $requite->bindValue(1, $AnneSId, PDO::PARAM_STR);
            $requite->bindValue(2, $AnneSNom, PDO::PARAM_STR);
            
            $requite->execute();
            header("location:../Show/showAnneScolaire.php");
    ...
    <header>
        ...
        <div class="header-admin">
            ...
            <div class="profile">
                ...
                <div id="nav-systeme">
                    <p><a href="./AnneScolaire.php"><i class="fa-solid fa-gear"></i> Ajouter Année Scolaire</a></p>
        ...
        <h1>Créer une Nouvelle Anne Scolaire</h1>
        
        <form action="#" method="POST">
            <!-- Champ pour ID de la Anne Scolaire -->
            <div class="form-group">
                <label for="class-name">ID de la Anne Scolaire</label>
                <input type="text" id="class-name" name="AnneSId" placeholder="Entrez ID de la Anne Scolaire" required>
            </div>
            
            <!-- Champ pour le nom de la Anne Scolaire -->
            <div class="form-group">
                <label for="FiliereName">Nom de la Anne Scolaire</label>
                <input type="text" id="instructor" name="AnneSName" placeholder="Veuillez entrer le nom de la Anne Scolaire" required>
            </div>
            ...
            <div class="form-group">
                <button type="submit" name="creer" class="submit-btn">Créer la Anne Scolaire</button>           
            </div>
